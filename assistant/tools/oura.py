...
- инструмент get_oura_trend возвращает days_of_data. Если оно меньше
  {CALIBRATION_DAYS} — идёт калибровка: нормы ещё нет. Можно назвать факт
  («спала 6 часов»), но НЕЛЬЗЯ говорить про отклонение, разгон и
  «звоночки». Так и скажи: кольцо ещё набирает её норму.
